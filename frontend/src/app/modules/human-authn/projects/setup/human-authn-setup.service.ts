...
export class HumanAuthnSetupService {
    ...
    readonly formKeys: Record<number, string[]> = {
        ...
        3: ['projectFlow.humanAuthn.mode', 'projectFlow.humanAuthn.outputFormat', 'projectFlow.humanAuthn.tolerance'],
    ...
    getDefaultProjectFlow(): Record<string, unknown> {
        return {
            ...
            humanAuthn: {
                mode: 'standard',
                livenessAtCreation: false,
                outputFormat: 'string',
                tolerance: 'REGULAR',
                compareMinScore: 0.85,
                verifierKey: '',
                publicDataKeys: ['fullName'],
            },
