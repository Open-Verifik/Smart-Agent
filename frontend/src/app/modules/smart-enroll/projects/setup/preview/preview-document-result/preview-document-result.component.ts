...
@Component({
    selector: 'preview-document-result',
    standalone: true,
    imports: [CommonModule, MatIconModule, TranslocoModule],
    templateUrl: './preview-document-result.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PreviewDocumentResultComponent implements OnInit, OnChanges {
