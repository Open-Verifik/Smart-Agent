...
export const defaultNavigation: FuseNavigationItem[] = [
        ...
        children: [
    {
        ...
        children: [
            ...
            {
                id: 'check-list',
                title: 'nav.check_list',
                subtitle: 'nav.check_list_subtitle',
                type: 'basic',
        ...
        children: [
            {
                ...
                title: 'nav.smart_fleet_dashboard',
                subtitle: 'nav.smart_fleet_dashboard_subtitle',
                type: 'basic',
            ...
            {
                id: 'smart-fleet-assets',
                title: 'nav.smart_fleet_assets',
                subtitle: 'nav.smart_fleet_assets_subtitle',
                type: 'basic',
                icon: 'heroicons_outline:truck',
                link: '/smart-fleet/assets',
            },
            {
                id: 'smart-fleet-watch-rules',
                title: 'nav.smart_fleet_watch_rules',
                subtitle: 'nav.smart_fleet_watch_rules_subtitle',
                type: 'basic',
                icon: 'heroicons_outline:adjustments-horizontal',
                link: '/smart-fleet/watch-rules',
            },
            {
                id: 'smart-fleet-alerts',
                title: 'nav.smart_fleet_alerts',
                subtitle: 'nav.smart_fleet_alerts_subtitle',
                type: 'basic',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                type: 'basic',
                icon: 'heroicons_outline:play-circle',
                link: '/human-authn/demos',
            },
            {
                id: 'human-authn-history',
                title: 'nav.history',
                subtitle: 'nav.history_subtitle',
                type: 'basic',
                icon: 'heroicons_outline:clock',
                link: '/human-authn/history',
            },
            {
                type: 'divider',
            },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: 'nav.whatsapp_messages',
                subtitle: 'nav.whatsapp_messages_subtitle',
                type: 'basic',
                icon: 'heroicons_outline:chat-bubble-left-ellipsis',
                link: '/smart-tools/whatsapp-messages',
            },
            {
                id: 'sms-messages',
                title: 'nav.sms_messages',
                subtitle: 'nav.sms_messages_subtitle',
                type: 'basic',
