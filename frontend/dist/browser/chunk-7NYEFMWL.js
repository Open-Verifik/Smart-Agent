...
var smart_batch_routes_default = [
  ...
  {
    path: "create",
    loadComponent: () => import("./chunk-5WW4FHEO.js").then((m) => m.CreateBatchConfigComponent)
  },
  {
    path: "edit/:id",
    loadComponent: () => import("./chunk-5WW4FHEO.js").then((m) => m.CreateBatchConfigComponent)
  ...
  {
    path: ":configId",
    loadComponent: () => import("./chunk-VNWYTRYI.js").then((m) => m.BatchDashboardComponent)
  },
  {
    path: ":configId/batch/new",
    loadComponent: () => import("./chunk-W3YCKCEL.js").then((m) => m.CreateBatchComponent)
  },
  {
    path: ":configId/batch/:batchId",
    loadComponent: () => import("./chunk-AG76MMGG.js").then((m) => m.BatchProcessingComponent)
  },
  {
    path: ":configId/report-builder",
    loadComponent: () => import("./chunk-RG2UF6PF.js").then((m) => m.ReportBuilderComponent)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-5EJCVYDY.js").then((m) => m.ReportViewerComponent)
  }
];
export {
  smart_batch_routes_default as default
};
//# sourceMappingURL=chunk-7NYEFMWL.js.map
