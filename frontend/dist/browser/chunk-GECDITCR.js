...
import "./chunk-6JQSEQ6B.js";
import "./chunk-Y5VEUI6L.js";
import "./chunk-3PFCPE6U.js";
import "./chunk-NLVEQCVI.js";
...
var ChatComponent = class _ChatComponent {
      ...
      this.http.post(`${this.apiUrl}/chat`, payload, { observe: "response" }).subscribe({
        next: (httpResponse) => {
          ...
          if (msg.data && msg.role === "assistant") {
            const paymentMsgs = this.messages().filter((m) => m.role === "system" && (m.paymentTx || m.content.includes("TX:"))).reverse();
  ...
  fetchProofAsync(msg, messageIndex) {
    ...
    if (this.lastPaymentTx()) {
      ...
      const paymentMsgs = this.messages().filter((m) => m.role === "system" && m.content.includes("TX:")).reverse();
...
//# sourceMappingURL=chunk-GECDITCR.js.map
