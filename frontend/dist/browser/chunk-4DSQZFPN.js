...
var smart_enroll_projects_routes_default = [
  {
    path: "",
    loadComponent: () => import("./chunk-RXBBYLWD.js").then((m) => m.ProjectListComponent)
  },
  {
    path: "new/setup/:step",
    loadComponent: () => import("./chunk-5G22P75P.js").then((m) => m.SetupHostComponent),
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-44BYEMNB.js").then((m) => m.ProjectRecordDetailComponent)
  },
  {
    path: ":projectId/records",
    loadComponent: () => import("./chunk-UXQDFGG7.js").then((m) => m.ProjectRecordsComponent)
  },
  {
    path: ":projectId/staff",
    loadComponent: () => import("./chunk-CDIIWBOH.js").then((m) => m.ProjectStaffComponent)
  },
  {
  ...
  {
    path: ":projectId",
    loadComponent: () => import("./chunk-XTHYYL5H.js").then((m) => m.ProjectDetailComponent)
  }
];
export {
  smart_enroll_projects_routes_default as default
};
//# sourceMappingURL=chunk-4DSQZFPN.js.map
