...
var _c1 = (a0) => ({ plan: a0 });
function SubscriptionPlansComponent_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "h1");
    \u0275\u0275text(2);
...
function SubscriptionPlansComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "h1");
    \u0275\u0275text(2);
...
function SubscriptionPlansComponent_div_13_span_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 36);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
...
function SubscriptionPlansComponent_div_13_span_35_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_13_div_47_ng_container_5_div_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const feature_r3 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(feature_r3.value);
  }
}
function SubscriptionPlansComponent_div_13_div_47_ng_container_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 43);
    ...
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SubscriptionPlansComponent_div_13_div_47_ng_container_5_div_1_span_6_Template, 2, 1, "span", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 2, "pricing." + feature_r3.key));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", feature_r3.value && !ctx_r1.isBoolean(feature_r3.value));
  }
}
function SubscriptionPlansComponent_div_13_div_47_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_13_div_47_ng_container_5_div_1_Template, 7, 4, "div", 41);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const feature_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", feature_r3.key !== "OCR");
  }
}
function SubscriptionPlansComponent_div_13_div_47_ng_container_6_div_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 46);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SubscriptionPlansComponent_div_13_div_47_ng_container_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 43);
    ...
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SubscriptionPlansComponent_div_13_div_47_ng_container_6_div_1_span_6_Template, 2, 1, "span", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SubscriptionPlansComponent_div_13_div_47_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_13_div_47_ng_container_6_div_1_Template, 7, 4, "div", 41);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function SubscriptionPlansComponent_div_13_div_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, SubscriptionPlansComponent_div_13_div_47_ng_container_5_Template, 2, 1, "ng-container", 40)(6, SubscriptionPlansComponent_div_13_div_47_ng_container_6_Template, 2, 1, "ng-container", 40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_13_div_48_button_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 55);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_13_div_48_button_21_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function SubscriptionPlansComponent_div_13_div_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "h3", 48);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 49)(5, "p", 50);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 53);
    \u0275\u0275element(17, "path", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275pipe(20, "transloco");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(21, SubscriptionPlansComponent_div_13_div_48_button_21_Template, 6, 3, "button", 54);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_13_div_49_div_5_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_13_div_49_div_6_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_13_div_49_div_7_option_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCountryDisplayName(c_r7), " ");
  }
}
function SubscriptionPlansComponent_div_13_div_49_div_7_option_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 74);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCategoryDisplayName(cat_r8), " ");
  }
}
function SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_tr_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.getCategoryDisplayName(group_r9.category));
  }
}
function SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_tr_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 79);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_tr_2_Template_tr_click_0_listener() {
      const feature_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r1.openFeatureModal(feature_r11));
    });
    \u0275\u0275elementStart(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.getFeatureDisplayName(feature_r11));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(5, 3, ctx_r1.getEffectivePriceForApi(feature_r11, ctx_r1.currentSubscription.subscriptionPlan), "1.2-4"), " ", \u0275\u0275pipeBind1(6, 6, "subscriptionPlans.credits"), " ");
  }
}
function SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_tr_1_Template, 3, 1, "tr", 75)(2, SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_tr_2_Template, 7, 8, "tr", 76);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", group_r9.category);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", group_r9.features)("ngForTrackBy", ctx_r1.trackByFeature);
  }
}
function SubscriptionPlansComponent_div_13_div_49_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 66)(1, "div", 67)(2, "input", 68);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275listener("input", function SubscriptionPlansComponent_div_13_div_49_div_7_Template_input_input_2_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.myListSearchQuery = $event.target.value);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "select", 69);
    \u0275\u0275twoWayListener("ngModelChange", function SubscriptionPlansComponent_div_13_div_49_div_7_Template_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r1.myListCountryFilter, $event) || (ctx_r1.myListCountryFilter = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(5, "option", 70);
    \u0275\u0275text(6, "All countries");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, SubscriptionPlansComponent_div_13_div_49_div_7_option_7_Template, 2, 2, "option", 71);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "select", 69);
    \u0275\u0275twoWayListener("ngModelChange", function SubscriptionPlansComponent_div_13_div_49_div_7_Template_select_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, SubscriptionPlansComponent_div_13_div_49_div_7_option_11_Template, 2, 2, "option", 71);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "table", 72)(13, "thead")(14, "tr")(15, "th");
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(22, SubscriptionPlansComponent_div_13_div_49_div_7_ng_container_22_Template, 3, 3, "ng-container", 73);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SubscriptionPlansComponent_div_13_div_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "div", 59)(2, "h3");
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, SubscriptionPlansComponent_div_13_div_49_div_5_Template, 2, 0, "div", 60)(6, SubscriptionPlansComponent_div_13_div_49_div_6_Template, 3, 3, "div", 61)(7, SubscriptionPlansComponent_div_13_div_49_div_7_Template, 23, 16, "div", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(14, "transloco");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 22)(16, "div", 23)(17, "span", 24);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275template(34, SubscriptionPlansComponent_div_13_span_34_Template, 3, 3, "span", 26)(35, SubscriptionPlansComponent_div_13_span_35_Template, 3, 3, "span", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div", 28)(37, "button", 29);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_13_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_13_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.switchToExplore());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(43, "svg", 8);
    \u0275\u0275element(44, "path", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275text(45);
    \u0275\u0275pipe(46, "transloco");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(47, SubscriptionPlansComponent_div_13_div_47_Template, 7, 5, "div", 33)(48, SubscriptionPlansComponent_div_13_div_48_Template, 22, 13, "div", 34)(49, SubscriptionPlansComponent_div_13_div_49_Template, 8, 6, "div", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SubscriptionPlansComponent_div_14_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 63);
    \u0275\u0275element(1, "div", 64);
    \u0275\u0275elementEnd();
...
function SubscriptionPlansComponent_div_14_div_13_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 105)(1, "label", 106);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 107)(5, "input", 108);
    \u0275\u0275listener("input", function SubscriptionPlansComponent_div_14_div_13_div_12_Template_input_input_5_listener($event) {
      \u0275\u0275restoreView(_r14);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onRequestsInput($event.target.value));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 4, "subscriptionPlans.estimator.requestsLabel"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("max", ctx_r1.sliderMax)("value", ctx_r1.sliderValue);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 6, ctx_r1.selectedInterval === "year" ? "subscriptionPlans.requestSlider.requestsPerYear" : "subscriptionPlans.requestSlider.requests"), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_13_div_12_option_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 74);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const plan_r17 = ctx.$implicit;
    \u0275\u0275property("value", plan_r17._id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plan_r17.name, " ");
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_13_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 114)(1, "label", 115);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "select", 116);
    \u0275\u0275listener("ngModelChange", function SubscriptionPlansComponent_div_14_div_13_div_13_div_12_Template_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.onReferencePlanChange($event));
    });
    \u0275\u0275template(5, SubscriptionPlansComponent_div_14_div_13_div_13_div_12_option_5_Template, 2, 2, "option", 71);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, "subscriptionPlans.estimator.referenceLabel"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.budgetReferencePlanId);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.visiblePlans);
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 105)(1, "label", 110);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 107)(5, "span", 111);
    \u0275\u0275text(6, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "input", 112);
    \u0275\u0275pipe(8, "transloco");
    \u0275\u0275listener("input", function SubscriptionPlansComponent_div_14_div_13_div_13_Template_input_input_7_listener($event) {
      \u0275\u0275restoreView(_r15);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onBudgetInput($event.target.value));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, SubscriptionPlansComponent_div_14_div_13_div_13_div_12_Template, 6, 5, "div", 113);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 5, "subscriptionPlans.estimator.budgetLabel"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 7, "subscriptionPlans.estimator.budgetPlaceholder"))("value", ctx_r1.targetMonthlyBudget);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" /", \u0275\u0275pipeBind1(11, 9, "subscriptionPlans.interval.month"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.visiblePlans.length > 1);
  }
}
function SubscriptionPlansComponent_div_14_div_13_span_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(tick_r18);
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_27_span_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const delta_r19 = ctx.ngIf;
    \u0275\u0275classProp("over", delta_r19 > 0)("under", delta_r19 < 0);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" (", delta_r19 > 0 ? "+" : "", "$", \u0275\u0275pipeBind2(2, 6, delta_r19, "1.0-2"), ") ");
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "number");
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275template(8, SubscriptionPlansComponent_div_14_div_13_div_27_span_8_Template, 3, 9, "span", 117);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 4, "subscriptionPlans.estimator.closestFor", \u0275\u0275pureFunction1(12, _c1, ctx_r1.budgetReferencePlan.name)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" $", \u0275\u0275pipeBind2(6, 7, ctx_r1.getBudgetAchievedTotal(), "1.0-0"), "/", \u0275\u0275pipeBind1(7, 10, "subscriptionPlans.interval.month"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.getBudgetDelta());
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_28_ng_container_1_div_12_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_14_div_13_div_28_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, SubscriptionPlansComponent_div_14_div_13_div_28_ng_container_1_div_12_Template, 3, 3, "div", 124);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const plan_r20 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275classProp("best-value", plan_r20._id === ctx_r1.getBestValuePlanId());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(plan_r20.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" $", ctx_r1.getEffectiveCostPerRequest(plan_r20).toFixed(4), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("/ ", \u0275\u0275pipeBind1(8, 7, "subscriptionPlans.requestSlider.perRequest"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ~$", \u0275\u0275pipeBind2(11, 9, ctx_r1.getEstimatedTotal(plan_r20), "1.0-0"), "/mo ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", plan_r20._id === ctx_r1.getBestValuePlanId());
  }
}
function SubscriptionPlansComponent_div_14_div_13_div_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 119);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_14_div_13_div_28_ng_container_1_Template, 13, 12, "ng-container", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SubscriptionPlansComponent_div_14_div_13_div_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 126)(1, "button", 127);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_13_div_29_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r21);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function SubscriptionPlansComponent_div_14_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 89)(1, "div", 90)(2, "div", 91)(3, "button", 92);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_13_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setEstimatorMode("requests"));
    });
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 92);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_13_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setEstimatorMode("budget"));
    });
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "transloco");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(11, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, SubscriptionPlansComponent_div_14_div_13_div_12_Template, 9, 8, "div", 94)(13, SubscriptionPlansComponent_div_14_div_13_div_13_Template, 13, 11, "div", 94);
    \u0275\u0275elementStart(14, "div", 95)(15, "input", 96);
    \u0275\u0275listener("input", function SubscriptionPlansComponent_div_14_div_13_Template_input_input_15_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275template(17, SubscriptionPlansComponent_div_14_div_13_span_17_Template, 2, 1, "span", 40);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 98)(19, "div", 99)(20, "span", 100);
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(26, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(27, SubscriptionPlansComponent_div_14_div_13_div_27_Template, 9, 14, "div", 102);
    \u0275\u0275elementEnd();
    \u0275\u0275template(28, SubscriptionPlansComponent_div_14_div_13_div_28_Template, 2, 1, "div", 103)(29, SubscriptionPlansComponent_div_14_div_13_div_29_Template, 4, 3, "div", 104);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275classProp("active", ctx_r1.estimatorMode === "requests");
    \u0275\u0275attribute("aria-selected", ctx_r1.estimatorMode === "requests");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 23, "subscriptionPlans.estimator.modeRequests"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", ctx_r1.estimatorMode === "budget");
    \u0275\u0275attribute("aria-selected", ctx_r1.estimatorMode === "budget");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 25, "subscriptionPlans.estimator.modeBudget"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 27, "subscriptionPlans.requestSlider.basePrice"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.estimatorMode === "requests");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.estimatorMode === "budget");
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", "linear-gradient(to right, #6366f1 " + ctx_r1.sliderValue / ctx_r1.sliderMax * 100 + "%, #e2e8f0 " + ctx_r1.sliderValue / ctx_r1.sliderMax * 100 + "%)");
    \u0275\u0275property("max", ctx_r1.sliderMax)("step", ctx_r1.sliderStep)("value", ctx_r1.sliderValue);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r1.sliderTicks);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 29, "subscriptionPlans.estimator.resolvedRequests"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(25, 31, ctx_r1.sliderValue, "1.0-0"), " ", \u0275\u0275pipeBind1(26, 34, ctx_r1.selectedInterval === "year" ? "subscriptionPlans.requestSlider.requestsPerYear" : "subscriptionPlans.requestSlider.requests"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.estimatorMode === "budget" && ctx_r1.budgetReferencePlan);
    \u0275\u0275advance();
...
function SubscriptionPlansComponent_div_14_div_14_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 63);
    \u0275\u0275element(1, "div", 64);
    \u0275\u0275elementEnd();
...
function SubscriptionPlansComponent_div_14_div_14_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
...
function SubscriptionPlansComponent_div_14_div_14_div_10_option_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 74);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCountryDisplayName(c_r24), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_option_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 74);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275property("value", cat_r25);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCategoryDisplayName(cat_r25), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_th_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plan_r26.name, " ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 77)(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const group_r27 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275attribute("colspan", ctx_r1.apiBreakdownPlans.length + 1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getCategoryDisplayName(group_r27.category), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_2_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const plan_r30 = ctx.$implicit;
    const feature_r29 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" $", ctx_r1.getCompareTablePriceForApi(feature_r29, plan_r30).toFixed(4), "/req ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r28 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 79);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_2_Template_tr_click_0_listener() {
      const feature_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r1.openFeatureModal(feature_r29));
    });
    \u0275\u0275elementStart(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_2_td_3_Template, 2, 1, "td", 73);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const feature_r29 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.getFeatureDisplayName(feature_r29));
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.apiBreakdownPlans)("ngForTrackBy", ctx_r1.trackByPlan);
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_1_Template, 3, 2, "tr", 75)(2, SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_tr_2_Template, 4, 3, "tr", 76);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", group_r27.category);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", group_r27.features)("ngForTrackBy", ctx_r1.trackByFeature);
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_div_21_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const plan_r31 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", plan_r31.name, " = $", \u0275\u0275pipeBind2(2, 2, ctx_r1.getDisplayEstimatedTotal(plan_r31), "1.0-0"), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_14_div_10_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 131)(1, "span", 132);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, SubscriptionPlansComponent_div_14_div_14_div_10_div_21_span_4_Template, 3, 5, "span", 133);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function SubscriptionPlansComponent_div_14_div_14_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 66)(1, "div", 67)(2, "input", 68);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275listener("input", function SubscriptionPlansComponent_div_14_div_14_div_10_Template_input_input_2_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "select", 69);
    \u0275\u0275twoWayListener("ngModelChange", function SubscriptionPlansComponent_div_14_div_14_div_10_Template_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(6, "All countries");
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, SubscriptionPlansComponent_div_14_div_14_div_10_option_7_Template, 2, 2, "option", 71);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "select", 69);
    \u0275\u0275twoWayListener("ngModelChange", function SubscriptionPlansComponent_div_14_div_14_div_10_Template_select_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(10, "All categories");
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, SubscriptionPlansComponent_div_14_div_14_div_10_option_11_Template, 2, 2, "option", 71);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "table", 72)(13, "thead")(14, "tr")(15, "th");
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275template(18, SubscriptionPlansComponent_div_14_div_14_div_10_th_18_Template, 2, 1, "th", 73);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "tbody");
    \u0275\u0275template(20, SubscriptionPlansComponent_div_14_div_14_div_10_ng_container_20_Template, 3, 3, "ng-container", 73);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, SubscriptionPlansComponent_div_14_div_14_div_10_div_21_Template, 5, 6, "div", 130);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function SubscriptionPlansComponent_div_14_div_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 128)(1, "div", 59)(2, "h3");
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 129);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_14_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r22);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(7, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, SubscriptionPlansComponent_div_14_div_14_div_8_Template, 2, 0, "div", 60)(9, SubscriptionPlansComponent_div_14_div_14_div_9_Template, 3, 3, "div", 61)(10, SubscriptionPlansComponent_div_14_div_14_div_10_Template, 22, 16, "div", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_14_div_15_div_2_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_14_div_15_div_2_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function SubscriptionPlansComponent_div_14_div_15_div_2_p_16_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const plan_r33 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" $", ctx_r1.getAmountByMonth(plan_r33), "/", \u0275\u0275pipeBind1(2, 3, "subscriptionPlans.interval.month"), " ", \u0275\u0275pipeBind1(3, 5, "subscriptionPlans.billedAnnually"), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_15_div_2_div_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("$", \u0275\u0275pipeBind2(5, 3, ctx_r1.getDisplayRequestAddOn(plan_r33), "1.0-0"), "");
    \u0275\u0275advance(3);
...
function SubscriptionPlansComponent_div_14_div_15_div_2_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 158)(1, "span", 159);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 160)(5, "span", 161);
    \u0275\u0275text(6, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 162);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span", 163);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "transloco");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(9, 5, ctx_r1.getDisplayEstimatedTotal(plan_r33), "1.0-0"));
    \u0275\u0275advance(3);
...
function SubscriptionPlansComponent_div_14_div_15_div_2_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 164)(1, "span", 165);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 166);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "transloco");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.getDiscountDisplayText(plan_r33));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 2, "subscriptionPlans.discountDescription"));
  }
}
function SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
...
function SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
...
function SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
  ...
  if (rf & 2) {
    const plan_r33 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plan_r33.isDowngrade ? \u0275\u0275pipeBind1(2, 1, "subscriptionPlans.downgrade") : \u0275\u0275pipeBind1(3, 3, "subscriptionPlans.upgrade"), " ");
  }
}
function SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_ng_container_1_Template, 3, 3, "ng-container", 10)(2, SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_ng_container_2_Template, 4, 5, "ng-container", 10);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function SubscriptionPlansComponent_div_14_div_15_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r32 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 137);
    \u0275\u0275template(1, SubscriptionPlansComponent_div_14_div_15_div_2_div_1_Template, 3, 3, "div", 138)(2, SubscriptionPlansComponent_div_14_div_15_div_2_div_2_Template, 3, 3, "div", 139);
    \u0275\u0275elementStart(3, "div", 140)(4, "h3");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 141)(7, "div", 142)(8, "span", 143);
    \u0275\u0275text(9, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span", 144);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "span", 145);
    \u0275\u0275text(14);
    \u0275\u0275pipe(15, "transloco");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, SubscriptionPlansComponent_div_14_div_15_div_2_p_16_Template, 4, 7, "p", 146)(17, SubscriptionPlansComponent_div_14_div_15_div_2_div_17_Template, 9, 8, "div", 147)(18, SubscriptionPlansComponent_div_14_div_15_div_2_div_18_Template, 13, 10, "div", 148);
    \u0275\u0275elementEnd();
    \u0275\u0275template(19, SubscriptionPlansComponent_div_14_div_15_div_2_div_19_Template, 6, 4, "div", 149);
    \u0275\u0275elementStart(20, "button", 150);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_15_div_2_Template_button_click_20_listener() {
      const plan_r33 = \u0275\u0275restoreView(_r32).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.upgradePlan(plan_r33));
    });
    \u0275\u0275template(21, SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_21_Template, 3, 3, "ng-container", 10)(22, SubscriptionPlansComponent_div_14_div_15_div_2_ng_container_22_Template, 3, 2, "ng-container", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const plan_r33 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("popular", plan_r33.name === "Plus")("current", plan_r33.code === (ctx_r1.currentSubscription == null ? null : ctx_r1.currentSubscription.subscriptionPlan == null ? null : ctx_r1.currentSubscription.subscriptionPlan.code))("best-value-card", plan_r33._id && plan_r33._id === ctx_r1.getBestValuePlanId() && ctx_r1.requestsPerMonth > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", plan_r33.name === "Plus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", plan_r33._id && plan_r33._id === ctx_r1.getBestValuePlanId() && ctx_r1.requestsPerMonth > 0 && plan_r33.name !== "Plus");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(plan_r33.name);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("price-muted", ctx_r1.requestsPerMonth > 0 && ctx_r1.getDisplayRequestAddOn(plan_r33) > 0);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(12, 22, plan_r33.amount, "1.0-0"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("/", \u0275\u0275pipeBind1(15, 25, "subscriptionPlans.interval." + plan_r33.interval), "");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", plan_r33.interval === "year" && !(ctx_r1.requestsPerMonth > 0 && ctx_r1.getDisplayRequestAddOn(plan_r33) > 0));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.requestsPerMonth > 0 && ctx_r1.getDisplayRequestAddOn(plan_r33) > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.requestsPerMonth > 0 && ctx_r1.getDisplayRequestAddOn(plan_r33) > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", plan_r33.discount == null ? null : plan_r33.discount.discount);
    \u0275\u0275advance();
    \u0275\u0275classProp("btn-current", plan_r33.code === (ctx_r1.currentSubscription == null ? null : ctx_r1.currentSubscription.subscriptionPlan == null ? null : ctx_r1.currentSubscription.subscriptionPlan.code));
    \u0275\u0275property("disabled", plan_r33.code === (ctx_r1.currentSubscription == null ? null : ctx_r1.currentSubscription.subscriptionPlan == null ? null : ctx_r1.currentSubscription.subscriptionPlan.code));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", plan_r33.code === (ctx_r1.currentSubscription == null ? null : ctx_r1.currentSubscription.subscriptionPlan == null ? null : ctx_r1.currentSubscription.subscriptionPlan.code));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", plan_r33.code !== (ctx_r1.currentSubscription == null ? null : ctx_r1.currentSubscription.subscriptionPlan == null ? null : ctx_r1.currentSubscription.subscriptionPlan.code));
  }
}
function SubscriptionPlansComponent_div_14_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 135, 0);
    \u0275\u0275template(2, SubscriptionPlansComponent_div_14_div_15_div_2_Template, 23, 27, "div", 136);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_14_div_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r34 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 167)(1, "button", 168);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_div_16_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r34);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SubscriptionPlansComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 80)(1, "div", 81)(2, "div", 82)(3, "button", 83);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_14_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(11, "transloco");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(12, SubscriptionPlansComponent_div_14_div_12_Template, 2, 0, "div", 60)(13, SubscriptionPlansComponent_div_14_div_13_Template, 30, 36, "div", 85)(14, SubscriptionPlansComponent_div_14_div_14_Template, 11, 9, "div", 86)(15, SubscriptionPlansComponent_div_14_div_15_Template, 3, 2, "div", 87)(16, SubscriptionPlansComponent_div_14_div_16_Template, 6, 3, "div", 88);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SubscriptionPlansComponent_div_15_div_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 186)(1, "label");
...
function SubscriptionPlansComponent_div_15_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 186)(1, "label");
    \u0275\u0275text(2, "Region");
    \u0275\u0275elementEnd();
...
function SubscriptionPlansComponent_div_15_div_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 201)(1, "label");
    \u0275\u0275text(2, "Your Pricing");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 202)(4, "span", 203);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 204);
    \u0275\u0275text(8, "CREDITS ");
    \u0275\u0275elementStart(9, "span", 205);
    \u0275\u0275text(10, "/ request");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function SubscriptionPlansComponent_div_15_div_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 201)(1, "label");
...
function SubscriptionPlansComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r35 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 170);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_15_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r35);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeFeatureModal());
    });
    \u0275\u0275elementStart(1, "div", 171);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_15_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r35);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "button", 172);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_15_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r35);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeFeatureModal());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 173);
    \u0275\u0275element(4, "line", 174)(5, "line", 175);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "div", 176)(7, "div", 177);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 178)(9, "defs")(10, "linearGradient", 179);
    \u0275\u0275element(11, "stop", 180)(12, "stop", 181);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(13, "path", 182)(14, "path", 183);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "h2");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "p", 184);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 185)(20, "div", 186)(21, "label");
    \u0275\u0275text(22, "Endpoint URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 187);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_15_Template_div_click_23_listener() {
      \u0275\u0275restoreView(_r35);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 189);
    \u0275\u0275element(28, "rect", 190)(29, "path", 191);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(30, "div", 192);
    \u0275\u0275template(31, SubscriptionPlansComponent_div_15_div_31_Template, 5, 1, "div", 193)(32, SubscriptionPlansComponent_div_15_div_32_Template, 5, 1, "div", 193);
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, SubscriptionPlansComponent_div_15_div_33_Template, 11, 4, "div", 194)(34, SubscriptionPlansComponent_div_15_div_34_Template, 11, 4, "div", 194);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 195)(36, "button", 196);
    \u0275\u0275listener("click", function SubscriptionPlansComponent_div_15_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r35);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(38, "svg", 173);
    \u0275\u0275element(39, "line", 197)(40, "polyline", 198);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var SubscriptionPlansComponent = class _SubscriptionPlansComponent {
  constructor(_subscriptionService, _router, _route, _translocoService, _snackBar) {
    ...
    this.MONTHLY_SLIDER_STEP = 1;
    this.YEARLY_SLIDER_MAX = 5e5;
    this.YEARLY_SLIDER_STEP = 1;
    this.estimatorMode = "requests";
    this.targetMonthlyBudget = null;
    this.budgetReferencePlanId = "";
  ...
  setEstimatorMode(mode) {
    ...
    if (mode === "budget") {
      ...
      this.targetMonthlyBudget = plan ? Math.round(this.getEstimatedTotal(plan)) : null;
    }
  }
  /**
  ...
  getBudgetAchievedTotal() {
    const plan = this._getReferencePlan();
    return plan ? this.getEstimatedTotal(plan) : 0;
  }
  get budgetReferencePlan() {
    return this._getReferencePlan();
  }
  _setRequestsFromInterval(value) {
  ...
  _syncBudgetFromRequests() {
    if (this.estimatorMode !== "budget")
      return;
    const plan = this._getReferencePlan();
    if (!plan)
      return;
   ...
   */
  _findBestRForTargetPlan(plan, target) {
   ...
   */
  _autoPickReferenceAndRequestsForTarget(target) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SubscriptionPlansComponent, selectors: [["subscription-plans"]], viewQuery: function SubscriptionPlansComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275pipe(10, "transloco");
        \u0275\u0275elementEnd();
        \u0275\u0275template(11, SubscriptionPlansComponent_ng_container_11_Template, 7, 6, "ng-container", 10)(12, SubscriptionPlansComponent_ng_container_12_Template, 7, 6, "ng-container", 10);
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, SubscriptionPlansComponent_div_13_Template, 50, 39, "div", 11)(14, SubscriptionPlansComponent_div_14_Template, 17, 18, "div", 12);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(15, SubscriptionPlansComponent_div_15_Template, 41, 8, "div", 13);
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(8);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 12, "subscriptionPlans.badge"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", !ctx.currentSubscription);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.currentSubscription);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.currentView === "current" && ctx.currentSubscription);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.currentView === "explore");
        \u0275\u0275advance();
...
<div class="subscription-page">
    ...
    <div class="container">
        ...
        <div *ngIf="currentView === 'explore'" class="explore-section">
            ...
            <!-- Estimator: dual mode (requests vs monthly budget) -->
            <div class="estimator-card" *ngIf="!loadingPlans && plans.length > 0">
                <div class="estimator-mode-row">
                    <div class="estimator-mode-toggle" role="tablist">
                        <button
                            type="button"
                            role="tab"
                            [attr.aria-selected]="estimatorMode === 'requests'"
                            [class.active]="estimatorMode === 'requests'"
                            (click)="setEstimatorMode('requests')"
                        >
                            {{ 'subscriptionPlans.estimator.modeRequests' | transloco }}
                        </button>
                        <button
                            type="button"
                            role="tab"
                            [attr.aria-selected]="estimatorMode === 'budget'"
                            [class.active]="estimatorMode === 'budget'"
                            (click)="setEstimatorMode('budget')"
                        >
                            {{ 'subscriptionPlans.estimator.modeBudget' | transloco }}
                        </button>
                    </div>
                    <p class="estimator-hint">
                        {{ 'subscriptionPlans.requestSlider.basePrice' | transloco }}
                    </p>
                </div>

                <!-- Requests mode -->
                <div class="estimator-input-row" *ngIf="estimatorMode === 'requests'">
                    <label class="estimator-label" for="estimator-requests-input">
                        {{ 'subscriptionPlans.estimator.requestsLabel' | transloco }}
                    </label>
                    <div class="estimator-input-group">
                        <input
                            id="estimator-requests-input"
                            type="number"
                            class="estimator-number-input"
                            min="0"
                            [max]="sliderMax"
                            step="1"
                            inputmode="numeric"
                            [value]="sliderValue"
                            (input)="onRequestsInput($any($event.target).value)"
                        />
                        <span class="estimator-input-suffix">
                            {{
                ...
                <!-- Budget mode -->
                <div class="estimator-input-row" *ngIf="estimatorMode === 'budget'">
                    <label class="estimator-label" for="estimator-budget-input">
                        {{ 'subscriptionPlans.estimator.budgetLabel' | transloco }}
                    </label>
                    <div class="estimator-input-group">
                        <span class="estimator-input-prefix">$</span>
                        <input
                            id="estimator-budget-input"
                            type="number"
                            class="estimator-number-input"
                            min="0"
                            step="1"
                            inputmode="numeric"
                            [placeholder]="'subscriptionPlans.estimator.budgetPlaceholder' | transloco"
                    ...
                    <div class="estimator-reference-row" *ngIf="visiblePlans.length > 1">
                        <label class="estimator-reference-label" for="estimator-reference-plan">
                            {{ 'subscriptionPlans.estimator.referenceLabel' | transloco }}
                        </label>
                        <select
                            id="estimator-reference-plan"
                            class="estimator-reference-select"
                            [ngModel]="budgetReferencePlanId"
                            (ngModelChange)="onReferencePlanChange($event)"
                        >
                            <option *ngFor="let plan of visiblePlans" [value]="plan._id">
                                {{ plan.name }}
                            </option>
                        </select>
                    </div>
                ...
                <!-- Slider as secondary "quick adjust" -->
                ...
                <!-- Resolved summary line: requests + closest-total honesty -->
                <div class="estimator-summary">
                    <div class="estimator-summary-row">
                        <span class="estimator-summary-label">
                            {{ 'subscriptionPlans.estimator.resolvedRequests' | transloco }}
                        </span>
                        <span class="estimator-summary-value">
                            {{ sliderValue | number: '1.0-0' }}
                            {{
                                (selectedInterval === 'year'
                                    ? 'subscriptionPlans.requestSlider.requestsPerYear'
                                    : 'subscriptionPlans.requestSlider.requests'
                    ...
                    <div
                        class="estimator-summary-row"
                        *ngIf="estimatorMode === 'budget' && budgetReferencePlan"
                    >
                        <span class="estimator-summary-label">
                            {{ 'subscriptionPlans.estimator.closestFor' | transloco: { plan: budgetReferencePlan.name } }}
                        </span>
                        <span class="estimator-summary-value">
                            \${{ getBudgetAchievedTotal() | number: '1.0-0' }}/{{ 'subscriptionPlans.interval.month' | transloco }}
                            <span
                                class="estimator-delta"
                                *ngIf="getBudgetDelta() as delta"
                                [class.over]="delta > 0"
                                [class.under]="delta < 0"
                            >
                ...
                <!-- Per-plan cost chips (compact row) -->
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubscriptionPlansComponent, { className: "SubscriptionPlansComponent", filePath: "src/app/modules/subscription-plans/subscription-plans.component.ts", lineNumber: 47 });
})();
...
//# sourceMappingURL=chunk-6LWOW7SB.js.map
