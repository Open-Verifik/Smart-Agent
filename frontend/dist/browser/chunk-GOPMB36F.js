...
import "./chunk-KZ43L7A5.js";
import "./chunk-32POFUWR.js";
...
function StatusCheckComponent_mat_option_24_Template(rf, ctx) {
  if (rf & 1) {
...
function StatusCheckComponent_button_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 26);
    \u0275\u0275listener("click", function StatusCheckComponent_button_30_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
function StatusCheckComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
...
function StatusCheckComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "mat-icon", 30);
    \u0275\u0275text(2, "cloud_off");
    \u0275\u0275elementEnd();
...
function StatusCheckComponent_div_33_div_1_img_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 63);
  }
  if (rf & 2) {
...
function StatusCheckComponent_div_33_div_1_div_40_Template(rf, ctx) {
  if (rf & 1) {
...
function StatusCheckComponent_div_33_div_1_div_41_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function StatusCheckComponent_div_33_div_1_div_41_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function StatusCheckComponent_div_33_div_1_div_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 66);
    \u0275\u0275template(1, StatusCheckComponent_div_33_div_1_div_41_ng_container_1_Template, 2, 6, "ng-container", 67)(2, StatusCheckComponent_div_33_div_1_div_41_div_2_Template, 3, 3, "div", 68);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r7 = \u0275\u0275nextContext().$implicit;
...
function StatusCheckComponent_div_33_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 35)(1, "div", 36)(2, "div", 37)(3, "div", 38)(4, "h3", 39);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 40)(7, "span", 41);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(14, "currency");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(15, StatusCheckComponent_div_33_div_1_img_15_Template, 1, 2, "img", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 44)(17, "mat-icon", 45);
    \u0275\u0275text(18, "link");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 46);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 47)(22, "div", 48)(23, "span", 49);
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "transloco");
    \u0275\u0275pipe(26, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 50)(28, "button", 51);
    \u0275\u0275pipe(29, "transloco");
    \u0275\u0275pipe(30, "transloco");
    \u0275\u0275listener("click", function StatusCheckComponent_div_33_div_1_Template_button_click_28_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openDialog(item_r7));
    });
    \u0275\u0275elementStart(31, "mat-icon", 52);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 53)(34, "button", 54);
    \u0275\u0275listener("click", function StatusCheckComponent_div_33_div_1_Template_button_click_34_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function StatusCheckComponent_div_33_div_1_Template_button_click_37_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(39, "transloco");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(40, StatusCheckComponent_div_33_div_1_div_40_Template, 2, 1, "div", 55)(41, StatusCheckComponent_div_33_div_1_div_41_Template, 3, 2, "div", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "div", 57)(43, "div", 58)(44, "span", 59);
    \u0275\u0275text(45);
    \u0275\u0275pipe(46, "transloco");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(49, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(50, "div", 61)(51, "span", 59);
    \u0275\u0275text(52);
    \u0275\u0275pipe(53, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "span", 62);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function StatusCheckComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 33);
    \u0275\u0275template(1, StatusCheckComponent_div_33_div_1_Template, 56, 73, "div", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var StatusCheckComponent = class _StatusCheckComponent {
    ...
    this._statusCheckService.getAppFeatures({
      ...
      next: (result) => {
        ...
        if (Array.isArray(data)) {
          data.forEach((e2) => {
            if (e2.code !== "pdf_generator" && e2.code !== "online_postman") {
  ...
  updateTranslations() {
    if (!this.featureCodes.length)
      return;
    this.featureCodes.forEach((f2) => {
      const key = `appFeatures.${f2.code}.title`;
      const translated = this._translocoService.translate(key);
      f2.currentTranslation = translated !== key ? translated : f2.name;
    });
    if (this.dataSource.length) {
      this.dataSource.forEach((item) => {
        const f2 = item.subject.method;
        const key = `appFeatures.${f2.code}.title`;
        const translated = this._translocoService.translate(key);
        f2.currentTranslation = translated !== key ? translated : f2.name;
      });
  ...
  calculateFilters() {
    ...
    this.featureCodes.forEach((f2) => {
      if (f2.country) {
        countryCounts[f2.country] = (countryCounts[f2.country] || 0) + 1;
      }
    });
    this.countries = Object.entries(countryCounts).map(([name, count]) => ({ name, count })).sort((a2, b2) => b2.count - a2.count);
    const cats = /* @__PURE__ */ new Set();
    this.featureCodes.forEach((f2) => {
      if (f2.baseCategory) {
        cats.add(f2.baseCategory.toLowerCase());
      }
      if (["biometrics", "facerecognition", "faceverification"].includes(f2.group?.toLowerCase()) || f2.baseCategory?.toLowerCase() === "biometrics" || f2.baseCategory?.toLowerCase() === "faceverification") {
        cats.add("biometrics");
      }
    });
  ...
  getUptimes() {
    ...
    const methodMap = promises.map((p2) => p2.method);
    const obsList = promises.map((p2) => p2.promise);
    if (obsList.length === 0) {
      this.loading = false;
      return;
    }
    ...
    forkJoin(obsList).pipe(takeUntil(this._unsubscribeAll)).subscribe({
      next: (results) => {
        ...
        this.dataSource.sort((a2, b2) => {
          return a2.subject.percentage < b2.subject.percentage ? 1 : -1;
        });
        this.applyFilters();
        this.loading = false;
        this._cdr.markForCheck();
  ...
  processStatusRecord(listStatusRecord, method) {
    ...
    let errorCount = 0;
    const validPoints = listStatusRecord.filter((x2) => x2.status && x2.status !== "awaiting");
    ...
    const firstDate = listStatusRecord.find((x2) => x2.createdAt)?.createdAt;
  ...
  getGraphOptions(data) {
    const responseTimes = data.map((d2) => d2.responseTime || 0);
    return {
      series: [
        {
  ...
  applyFilters() {
    ...
    if (this.searchInput) {
      ...
      data = data.filter((item) => {
        const m2 = item.subject.method;
        return m2.name && m2.name.toLowerCase().includes(lowerQuery) || m2.url && m2.url.toLowerCase().includes(lowerQuery) || m2.currentTranslation && m2.currentTranslation.toLowerCase().includes(lowerQuery);
      });
    }
  ...
  openDialog(item) {
    import("./chunk-6M3JZXDS.js").then(({ SubscribeComponent }) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StatusCheckComponent, selectors: [["status-check"]], decls: 34, vars: 27, consts: [[1, "flex", "flex-col", "flex-auto", "min-w-0", "bg-gray-50", "dark:bg-gray-900", "min-h-screen"], [1, "flex", "flex-col", "w-full", "max-w-7xl", "mx-auto", "p-6", "md:p-8"], [1, "flex", "flex-col", "py-6", "mb-8", "border-b", "border-gray-200", "dark:border-gray-800"], [1, "flex", "items-center", "justify-between", "mb-6"], [1, "text-3xl", "font-bold", "tracking-tight", "text-gray-900", "dark:text-white"], [1, "text-lg", "text-gray-500", "dark:text-gray-400", "mt-1"], [1, "flex", "flex-col", "lg:flex-row", "lg:items-center", "justify-between", "gap-6"], [1, "flex", "items-center", "gap-1.5", "overflow-x-auto", "scrollbar-hide", "mask-gradient", "p-1", "-ml-1", "pl-1", "lg:max-w-[60%]"], ["class", "h-9 w-9 min-w-[2.25rem] flex items-center justify-center rounded-full border transition-all duration-200 relative group text-lg flex-shrink-0 aspect-square", 3, "bg-white", "shadow-sm", "border-gray-200", "bg-gray-900", "text-white", "border-transparent", "matTooltip", "click", 4, "ngFor", "ngForOf"], ["class", "text-sm text-gray-400 italic", 4, "ngIf"], [1, "flex", "flex-col", "sm:flex-row", "items-center", "gap-4", "w-full", "lg:w-auto"], [1, "w-full", "sm:w-48", "fuse-mat-dense", 3, "subscriptSizing"], ["matPrefix", "", 1, "icon-size-5", "text-gray-500", "ml-2", "mr-2"], [3, "selectionChange", "value", "placeholder"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], [1, "w-full", "sm:w-72", "fuse-mat-dense", 3, "subscriptSizing"], ["matPrefix", "", 1, "icon-size-5", "text-gray-500"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 3, "click", 4, "ngIf"], ["class", "flex flex-auto justify-center items-center py-20", 4, "ngIf"], ["class", "flex flex-col items-center justify-center py-20 text-center", 4, "ngIf"], ["class", "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", 4, "ngIf"], [1, "h-9", "w-9", "min-w-[2.25rem]", "flex", "items-center", "justify-center", "rounded-full", "border", "transition-all", "duration-200", "relative", "group", "text-lg", "flex-shrink-0", "aspect-square", 3, "click", "matTooltip"], [1, "leading-none"], [1, "text-sm", "text-gray-400", "italic"], ["matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 3, "click"], [1, "flex", "flex-auto", "justify-center", "items-center", "py-20"], ["diameter", "64"], [1, "flex", "flex-col", "items-center", "justify-center", "py-20", "text-center"], [1, "icon-size-24", "text-gray-300", "dark:text-gray-600", "mb-4"], [1, "text-xl", "font-medium", "text-gray-600", "dark:text-gray-400"], [1, "text-gray-500", "dark:text-gray-500", "max-w-sm", "mx-auto", "mt-2"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-3", "gap-6"], ["class", "flex flex-col bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-shadow hover:shadow-md", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "flex", "flex-col", "bg-white", "dark:bg-gray-800", "rounded-2xl", "shadow-sm", "border", "border-gray-200", "dark:border-gray-700", "overflow-hidden", "transition-shadow", "hover:shadow-md"], [1, "p-5", "border-b", "border-gray-100", "dark:border-gray-700/50", "bg-gray-50/30", "dark:bg-gray-800/50"], [1, "flex", "items-start", "justify-between"], [1, "flex", "flex-col", "min-w-0"], [1, "text-lg", "font-semibold", "text-gray-900", "dark:text-white", "truncate", 3, "title"], [1, "flex", "items-center", "mt-1", "space-x-2", "text-sm", "text-gray-500", "dark:text-gray-400"], [1, "uppercase", "tracking-wider", "text-xs", "font-medium", "px-2", "py-0.5", "rounded", "bg-gray-100", "dark:bg-gray-700", "text-gray-600", "dark:text-gray-300"], [1, "text-gray-300", "dark:text-gray-600", "px-1"], ["class", "w-6 h-auto rounded shadow-sm flex-shrink-0", 3, "src", "alt", 4, "ngIf"], [1, "flex", "items-center", "mt-3", "text-sm", "text-gray-500", "dark:text-gray-400", "font-mono", "bg-gray-50", "dark:bg-gray-900/50", "px-3", "py-1.5", "rounded-md", "border", "border-gray-100", "dark:border-gray-800"], [1, "icon-size-4", "mr-2", "text-gray-400"], [1, "truncate"], [1, "flex-auto", "p-5"], [1, "flex", "items-center", "justify-between", "mb-4"], [1, "text-sm", "font-medium", "text-gray-500", "dark:text-gray-400"], [1, "flex", "items-center", "gap-3"], [1, "flex", "items-center", "justify-center", "w-8", "h-8", "rounded-lg", "border", "border-gray-200", "dark:border-gray-700", "transition-all", "hover:bg-gray-50", "dark:hover:bg-gray-800", 3, "click", "matTooltip"], [1, "icon-size-4"], [1, "flex", "bg-gray-100", "dark:bg-gray-700", "p-1", "rounded-lg"], [1, "px-3", "py-1", "text-xs", "font-medium", "rounded-md", "transition-all", 3, "click"], ["class", "h-20 w-full overflow-hidden", 4, "ngIf"], ["class", "h-20 w-full flex items-end justify-between space-x-0.5", 4, "ngIf"], [1, "px-5", "py-4", "bg-gray-50/50", "dark:bg-gray-800/30", "border-t", "border-gray-100", "dark:border-gray-800", "flex", "items-center", "justify-between"], [1, "flex", "flex-col"], [1, "text-xs", "text-gray-400", "uppercase", "font-semibold", "tracking-wide"], [1, "text-lg", "font-bold"], [1, "text-right", "flex", "flex-col", "items-end"], [1, "text-sm", "font-medium", "text-gray-700", "dark:text-gray-300"], [1, "w-6", "h-auto", "rounded", "shadow-sm", "flex-shrink-0", 3, "src", "alt"], [1, "h-20", "w-full", "overflow-hidden"], [1, "w-full", "h-full", 3, "id"], [1, "h-20", "w-full", "flex", "items-end", "justify-between", "space-x-0.5"], [4, "ngFor", "ngForOf"], ["class", "w-full h-full flex items-center justify-center text-gray-400 text-sm", 4, "ngIf"], ["matTooltipPosition", "above", 1, "status-tick", "w-full", "flex-1", "rounded-sm", "transition-all", "hover:opacity-80", 3, "ngClass", "matTooltip"], [1, "w-full", "h-full", "flex", "items-center", "justify-center", "text-gray-400", "text-sm"]], template: function StatusCheckComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "div", 10)(16, "mat-form-field", 11)(17, "mat-icon", 12);
        \u0275\u0275text(18, "category");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "mat-select", 13);
        \u0275\u0275pipe(20, "transloco");
        \u0275\u0275listener("selectionChange", function StatusCheckComponent_Template_mat_select_selectionChange_19_listener($event) {
        ...
        \u0275\u0275pipe(23, "transloco");
        \u0275\u0275elementEnd();
        \u0275\u0275template(24, StatusCheckComponent_mat_option_24_Template, 3, 4, "mat-option", 15);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(25, "mat-form-field", 16)(26, "mat-icon", 17);
        \u0275\u0275text(27, "search");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(28, "input", 18);
        \u0275\u0275pipe(29, "transloco");
        \u0275\u0275listener("ngModelChange", function StatusCheckComponent_Template_input_ngModelChange_28_listener($event) {
          return ctx.filterData($event);
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(30, StatusCheckComponent_button_30_Template, 3, 0, "button", 19);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(31, StatusCheckComponent_div_31_Template, 2, 0, "div", 20)(32, StatusCheckComponent_div_32_Template, 9, 6, "div", 21)(33, StatusCheckComponent_div_33_Template, 2, 2, "div", 22);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 17, "network.title"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 19, "network.subtitle"), " ");
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("value", ctx.selectedCategory)("placeholder", \u0275\u0275pipeBind1(20, 21, "categories.label"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", null);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 23, "categories.all"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngForOf", ctx.categories);
        \u0275\u0275advance();
        \u0275\u0275property("subscriptSizing", "dynamic");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", ctx.searchInput)("placeholder", \u0275\u0275pipeBind1(29, 25, "network.search_placeholder"));
        \u0275\u0275advance(2);
...
apexcharts/dist/apexcharts.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-GOPMB36F.js.map
